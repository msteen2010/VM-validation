...
class MainWindow(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        """
        self.title('VMware VM Backup validation Utility')
        ...
        self.output_labelframe = tk.LabelFrame(text='VM validation output', height=350)
        ...
        self.backup_type_label = tk.Label(self.backup_labelframe, text='Backup Server:')
        self.server_type = ['NetWorker', 'PowerProtect Data Manager']
        self.server_selected = tk.StringVar()
        self.server_selected.set(self.server_type[0])
        self.backup_server_type = tk.OptionMenu(self.backup_labelframe, self.server_selected, *self.server_type)
        self.backup_server_type.config(width=35)
        ...
        self.backup_type_label.grid(row=0, column=0, sticky='E', padx=5, pady=5)
        self.backup_server_type.grid(row=0, column=1, sticky='W', pady=5)
        self.backup_server_label.grid(row=1, column=0, sticky='E', padx=5, pady=5)
        self.backup_server_input.grid(row=1, column=1, sticky='W', pady=5)
        self.backup_user_label.grid(row=2, column=0, sticky='E', padx=5, pady=5)
        self.backup_user_input.grid(row=2, column=1, sticky='W', pady=5)
        self.backup_pass_label.grid(row=3, column=0, sticky='E', padx=5, pady=5)
        self.backup_pass_input.grid(row=3, column=1, sticky='W', pady=5)
        self.backup_verify_label.grid(row=4, column=0, sticky='E', padx=5, pady=5)
        self.backup_verified_label.grid(row=4, column=1, sticky='W', padx=5, pady=5)
        ...
        self.vcenter_server_label.grid(row=0, column=0, sticky='E', padx=5, pady=5)
        self.vcenter_server_input.grid(row=0, column=1, sticky='W', pady=5)
        self.vcenter_user_label.grid(row=1, column=0, sticky='E', padx=5, pady=5)
        self.vcenter_user_input.grid(row=1, column=1, sticky='W', pady=5)
        self.vcenter_pass_label.grid(row=2, column=0, sticky='E', padx=5, pady=5)
        self.vcenter_pass_input.grid(row=2, column=1, sticky='W', pady=5)
        self.vcenter_verify_label.grid(row=3, column=0, sticky='E', padx=5, pady=5)
        ...
        self.directories_output_label.grid(row=0, column=0, sticky='E', padx=5, pady=5)
        ...
        self.directories_vm_label.grid(row=1, column=0, sticky='E', padx=5, pady=5)
        ...
        self.progress_total_vms_amount = tk.Label(self.progress_labelframe, text='0')
        self.progressed_vms_label = tk.Label(self.progress_labelframe, text='Number of VMs processed:')
        self.progressed_vms_amount = tk.Label(self.progress_labelframe, text='0')
        self.progress_total_vms_label.grid(row=0, column=0, sticky='E', padx=5, pady=5)
        self.progress_total_vms_amount.grid(row=0, column=1, sticky='E', padx=5, pady=5)
        self.progressed_vms_label.grid(row=1, column=0, sticky='E', padx=5, pady=5)
        ...
        self.output_screen = tk.Text(self.output_labelframe, height=20, width=146)
        ...
        self.input_list = [self.server_selected,
                           self.backup_server_input,
